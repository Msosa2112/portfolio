  ...
  return (
    ...
    >
      <style>{`
        ...
        .td-gallery-card {
          height: var(--gallery-item-height, 500px);
          min-width: 60px;
          transition: min-width 0.4s cubic-bezier(0.1, 0.7, 0, 1), height 0.4s cubic-bezier(0.1, 0.7, 0, 1);
        }

        .td-gallery-card.active {
          min-width: 280px;
        }
        ...
        .liquid-glass-overlay {
          ...
          transition: all 0.4s cubic-bezier(0.1, 0.7, 0, 1);
        }

        .td-gallery-card.active .liquid-glass-overlay {
          background: linear-gradient(135deg, rgba(255, 255, 255, 0.18) 0%, rgba(255, 255, 255, 0.06) 50%, rgba(255, 255, 255, 0) 51%, rgba(255, 255, 255, 0.03) 100%);
        ...
        @media (max-width: 640px) {
          ...
          .td-gallery-card-content {
            padding: 0.6rem !important;
          }

          .td-gallery-card-category {
            font-size: 7.5px !important;
          }

          .td-gallery-card-title {
            font-size: 0.85rem !important; /* text-sm */
            margin-bottom: 0.2rem !important;
          }

          .td-gallery-card-desc {
      ...
      <div
        ref={containerRef}
        className="td-gallery-container flex justify-center items-center w-full"
        style={{
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                flex: isActive ? 5.8 : 1,
                transformStyle: "preserve-3d",
                "--gallery-item-height": typeof itemHeight === "number" ? `${itemHeight}px` : itemHeight,
              }}
              className={cn(
                "td-gallery-card relative cursor-pointer select-none overflow-hidden rounded-2xl transition-all duration-300",
                isActive ? "active" : "",
                isActive
                  ? ""
                  : activeIndex === null
                    ? "grayscale-[0.25] brightness-[0.8] dark:brightness-[0.7]"
                    : "grayscale brightness-[0.4] dark:brightness-[0.3]",
                isFocused
                  ? "ring-2 ring-violet-500 ring-offset-2 dark:ring-offset-zinc-950 scale-[1.01]"
                  : "",
            ...
            >
              ...
              <div className="td-gallery-card-content absolute inset-0 flex flex-col justify-end p-5 z-[4] text-white overflow-hidden">
                <AnimatePresence>
                  {isActive && (
                    <div className="flex flex-col items-start w-full">
                      ...
                      <motion.span
                        ...
                        className="td-gallery-card-category text-[9px] font-black tracking-widest uppercase text-violet-400 mb-1"
                      >
                        {item.category}
                      </motion.span>
                      ...
                      <motion.h4
                        ...
                        className="td-gallery-card-title text-base md:text-lg lg:text-xl font-bold leading-tight tracking-tight mb-1 text-zinc-50"
                      >
                        {item.title}
                      </motion.h4>
                      ...
                      <motion.p
                        ...
                        className="td-gallery-card-desc text-[11px] md:text-xs font-medium leading-relaxed tracking-wide text-zinc-300 mb-3 max-w-[280px] sm:max-w-sm"
                      >
                        {item.description}
                      </motion.p>
